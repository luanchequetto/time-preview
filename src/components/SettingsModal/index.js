  ...
  return (
    ...
    >
      <ModalWrapper>
        ...
        <ListWrapper>
          <SettingsColorItem
            title="Cor de fundo primária"
            property={"backgroundPrimaryColor"}
          />
          <SettingsColorItem
            title="Cor de fundo secundária"
            property={"backgroundSecondColor"}
          />
          <SettingsColorItem
            title="Cor de fundo barra lateral"
            property={"sidebarColor"}
          />
          <SettingsColorItem
            title="Cor dos títulos"
            property={"textPrimaryColor"}
          />
          <SettingsColorItem
            title="Cor dos sub títulos"
            property={"textSecondColor"}
          />
        </ListWrapper>
        ...
        <ListWrapper>
          ...
          <SettingsPreferenceItem
            title="Linguagem"
            property={"lang"}
            options={[{ title: "Portugês", value: "pt_br" }]}
          />
        </ListWrapper>
        <SaveButton
          bg={defaultTheme.backgroundPrimaryColor}
          text={defaultTheme.textPrimaryColor}
